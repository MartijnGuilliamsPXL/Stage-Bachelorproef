...
void loop(void)
{
  ...
  for (int i = 0; i < SAMPLES; i++) {
    ...
    microseconds = micros();
    vReal[i] = max_value; //Choose any axis of the acceleration vector
    vImag[i] = 0;
  ...
  Serial.print(peak, 1); //Print the peak frequency in Hz
  Serial.print(",");
  Serial.print("Amplitude:");
  Serial.println(vReal[(int)peak]); //Print the peak amplitude
